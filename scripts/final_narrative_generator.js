// Final Narrative Generator
// Simple, reliable approach to generating narratives for RIAs without existing narratives
...
async function main() {
  ...
  log(`Starting narrative generation from CRD #${progress.lastProcessedCRD}`);
