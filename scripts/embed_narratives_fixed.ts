// Fixed embedding script for narratives using Vertex AI
...
// Get the embedding model using the correct API (matching lib/ai-providers.ts)
...
async function generateEmbedding(text: string): Promise<number[]> {
  try {
    // Use the correct Vertex AI embedding API (matching lib/ai-providers.ts)
    const request = {
