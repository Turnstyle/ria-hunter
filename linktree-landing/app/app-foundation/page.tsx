...
export default function AppFoundationPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gradient-to-br from-slate-900 via-sky-950 to-slate-900 text-slate-100 font-sans">
      {/* Header */}
      <header className="sticky top-0 z-50 py-4 px-6 md:px-10 flex justify-between items-center border-b border-slate-700/50 backdrop-blur-md bg-slate-900/70">
        <div className="flex items-center space-x-3">
          <a href="/" className="text-2xl font-bold tracking-tighter flex items-center">
            JTP <span className="text-sky-400">Nexus</span>
            <span className="text-xs text-slate-400 ml-2 self-end">/ App Foundation</span>
          </a>
        </div>
        <nav className="hidden md:flex items-center space-x-3">
          <Button variant="outline" className="text-slate-100 border-slate-600 hover:bg-sky-800 hover:text-white hover:scale-[1.03] hover:shadow-lg hover:shadow-sky-500/30 transition-all duration-200" asChild>
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden absolute top-16 right-0 left-0 z-40 bg-slate-800/95 backdrop-blur-sm p-4 border-b border-slate-700/50">
          <nav className="flex flex-col space-y-3">
            <Button variant="ghost" className="text-slate-100 justify-start hover:bg-sky-800 hover:text-white" asChild>
              <a href="https://github.com/JTPeters" target="_blank" rel="noopener noreferrer">
                <Github className="mr-2 h-4 w-4" /> My GitHub
              </a>
            </Button>
      ...
      <main className="flex-grow flex flex-col items-center justify-center p-6 text-center">
        <div className="max-w-4xl w-full">
          ...
          <section className="py-16 md:py-24">
            <Rocket className="h-20 w-20 text-sky-400 mx-auto mb-8 animate-pulse [filter:drop-shadow(0_0_8px_theme(colors.sky.400))_drop-shadow(0_0_16px_theme(colors.sky.500))]" />
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold mb-6 leading-tight">
              Building Awesome Apps, <span className="block text-sky-400">Supercharged by AI!</span>
            </h1>
            <p className="text-xl text-slate-400 mb-10 max-w-2xl mx-auto">
              Ever wonder how cool new apps get made? I&apos;m working on a special toolbox called <strong className="text-sky-300">App Foundation</strong>.
            ...
            <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
                <Button 
                    size="lg" 
                    className="bg-sky-500 hover:bg-sky-600 text-white text-lg py-3 px-8 rounded-lg shadow-lg hover:shadow-sky-500/40 transition-all duration-300 transform hover:scale-105"
                    asChild
                >
                  <a href="https://github.com/JTPeters" target="_blank" rel="noopener noreferrer">
                ...
                <Button 
                    size="lg" 
                    variant="outline"
                    className="text-sky-300 border-sky-400 hover:bg-sky-800 hover:text-white text-lg py-3 px-8 rounded-lg shadow-lg hover:shadow-sky-500/30 transition-all duration-300 transform hover:scale-105"
          ...
          <div id="learn-more-section" className="space-y-16 md:space-y-24 py-16 md:py-24">
            ...
            <section className="bg-slate-800/50 p-8 rounded-xl shadow-2xl border border-slate-700/50">
              <Layers className="h-16 w-16 text-sky-400 mx-auto mb-6" />
              <h2 className="text-3xl font-bold mb-4 text-sky-300">What&apos;s This &quot;App Foundation&quot; Gizmo?</h2>
              ...
              <ul className="list-disc list-inside text-left text-lg text-slate-300 mt-4 space-y-2 pl-4">
                <li><span className="text-sky-300 font-semibold">Strong Base:</span> Like a solid floor for your treehouse, so apps are stable and don&apos;t crash.</li>
                <li><span className="text-sky-300 font-semibold">Reusable Parts:</span> Think of ready-made windows or doors. These are bits of code I can use again and again, so I don&apos;t have to build everything from scratch each time. This means I can make apps FASTER!</li>
                <li><span className="text-sky-300 font-semibold">Smart Plans:</span> It helps organize everything so the apps are easy to fix or add new cool features to later on.</li>
              </ul>
            ...
            {/* AI Superpowers! */}
            <section className="bg-slate-800/50 p-8 rounded-xl shadow-2xl border border-slate-700/50">
              <Brain className="h-16 w-16 text-sky-400 mx-auto mb-6" />
              <h2 className="text-3xl font-bold mb-4 text-sky-300">AI Superpowers with Cursor!</h2>
              <p className="text-lg text-slate-300 leading-relaxed">
              ...
              <ul className="list-disc list-inside text-left text-lg text-slate-300 mt-4 space-y-2 pl-4">
                <li><span className="text-sky-300 font-semibold">Write Code Snippets:</span> If I need a specific piece of code, the AI can help write it super fast.</li>
                <li><span className="text-sky-300 font-semibold">Explain Tricky Stuff:</span> If there&apos;s something complicated, the AI can explain it in a way that&apos;s easier to understand.</li>
                <li><span className="text-sky-300 font-semibold">Spot Mistakes:</span> Like a helpful friend, it can help find tiny errors in the code that I might miss.</li>
                <li><span className="text-sky-300 font-semibold">Brainstorm Ideas:</span> Sometimes, the AI even helps me come up with new ideas for how to make things better!</li>
              </ul>
              <p className="text-lg text-slate-300 leading-relaxed mt-4">
            ...
            <section className="bg-slate-800/50 p-8 rounded-xl shadow-2xl border border-slate-700/50">
              <Share2 className="h-16 w-16 text-sky-400 mx-auto mb-6" />
              <h2 className="text-3xl font-bold mb-4 text-sky-300">The Cool Tools Inside My Kit</h2>
              ...
              <div className="grid md:grid-cols-2 gap-6 text-left">
                <div className="bg-slate-700/50 p-4 rounded-lg border border-slate-600">
                  <h3 className="font-semibold text-sky-300 text-xl mb-1">Next.js - The Speedy Delivery Van</h3>
                ...
                <div className="bg-slate-700/50 p-4 rounded-lg border border-slate-600">
                  <h3 className="font-semibold text-sky-300 text-xl mb-1">TypeScript - The Smart Blueprint</h3>
                ...
                <div className="bg-slate-700/50 p-4 rounded-lg border border-slate-600">
                  <h3 className="font-semibold text-sky-300 text-xl mb-1">Nx - The Giant Organizer</h3>
                ...
                <div className="bg-slate-700/50 p-4 rounded-lg border border-slate-600">
                  <h3 className="font-semibold text-sky-300 text-xl mb-1">Tailwind CSS - The Magic Paintbox</h3>
                ...
                <div className="bg-slate-700/50 p-4 rounded-lg border border-slate-600 md:col-span-2"> {/* Supabase spans two columns on medium screens and up */}
                  <h3 className="font-semibold text-sky-300 text-xl mb-1">Supabase - The All-in-One Helper</h3>
            ...
            <section className="py-12 text-center">
                <h2 className="text-3xl font-bold mb-4 text-sky-300">Want to See More of My Coding Adventures?</h2>
