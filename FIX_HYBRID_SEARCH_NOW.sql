-- IMMEDIATE FIX: Replace broken hybrid_search_rias function
-- This version properly filters during search, not after
...
BEGIN
    ...
    WHERE n.embedding_vector IS NOT NULL
        -- Apply state filter during the search
...
FROM hybrid_search_rias(
    ...
    (SELECT test_vec FROM missouri_embedding),
    0.3, 10, 'MO', 0, 0, NULL
);
