-- Create the missing search_rias and hybrid_search_rias functions
-- These functions match the API call signatures and implement proper state filtering

-- Enable pgvector extension
CREATE EXTENSION IF NOT EXISTS vector;

-- Drop existing functions if they exist
DROP FUNCTION IF EXISTS search_rias(vector(768), float, integer, text, numeric, numeric);
