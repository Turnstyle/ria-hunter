-- ============================================================
-- SEMANTIC SEARCH FIX - CORRECTED VERSION
-- ============================================================
...
-- Step 4: Convert JSON strings to vectors (FIXED VERSION)
DO $$
DECLARE
...
BEGIN
  ...
  LOOP
    ...
    RAISE NOTICE 'Converted % of % embeddings...', total_converted, total_to_convert;
